        ...
        <div className="missao">
          ...
          <div className="missao-descricao">
            <p>
              ...
              acolhedor para todas as pessoas.<br/>
              <hr/>
              Igualdade - Defendemos o direito de todas as pessoas a terem acesso igualitário à educação musical.
              <hr/>
              Qualidade - Comprometidos em fornecer recursos educacionais de qualidade, adaptados e acessiveis
            </p>
          </div>
        </div>
      </div>
