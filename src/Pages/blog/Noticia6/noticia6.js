        ...
        <>
            ...
            <div className="noticia-container">
                <div className="noticia-header">
                    <h6>Orquestra parassinfônica fará sua estreia na Sala São Paulo</h6>
                </div>
                <div className="noticia-content">
                    <p>
                        A Opesp, Orquestra Parassinfônica de São Paulo, está se preparando para sua estreia na Sala São Paulo no próximo dia 3 de dezembro, coincidindo com o Dia Internacional das Pessoas com Deficiência. Composta por 32 músicos, quase metade deles com deficiência, a orquestra foi formada a partir de um edital que selecionou talentos diversos.
                    </p>
                    <p>
                        Desde outubro, os músicos têm participado de intensivos ensaios para a estreia, que será conduzida pelo maestro Roberto Tibiriçá. A iniciativa foi idealizada por Igor Cayres, produtor cultural inspirado por músicos como João Carlos Martins e grupos como o coral de mulheres cegas, buscando destacar artistas com deficiência em papéis de destaque na música.
                    </p>
                    <p>
                        Um dos músicos da Opesp é Miriã Vitória dos Santos, que encontrou na música uma paixão desde a infância e agora toca violoncelo na orquestra. Diagnosticada com paralisia cerebral aos 2 anos, Miriã vê sua participação na Opesp como um marco de representatividade e profissionalização na música.
                    <img src={violoncelista} alt="Miriã Vitória, violoncelista da Orquestra Parasimfônica de São Paulo" className="violoncelista-img" />
                    </p>
                    <p>
                        O futuro da Opesp inclui mais apresentações em 2023 e a abertura de novos editais para integrar mais músicos com deficiência ao projeto, promovendo a diversidade na música clássica.
                    </p>
