        ...
        <section className="article-grid">
          ...
          <div className="article">
            ...
            <div className="article-content">
              <span className="category">{t('Cinema')}</span>
              <span className="read-time">5 {t('min de leitura')}</span>
              <h3>{t('Brasília terá mostra de cinema para deficientes visuais em setembro')}</h3>
              <p>{t('Versão Inclusiva de Capitol Na Tela disponibilizará quatro filmes com audiodescrições integradas e uma curta-metragem')}</p>
              <button>{t('Leia mais')}</button>
            </div>
          </div>
          ...
          <div className="article">
            ...
            <div className="article-content">
              ...
              <span className="read-time">4 {t('min de leitura')}</span>
              <h3>{t('Orquestra Parassinfônica encerra temporada 2023 na Sala São Paulo')}</h3>
              <p>{t('A Orquestra Parassinfônica de São Paulo - OPESP - a primeira orquestra brasileira que dá protagonismo a pessoas com deficiência, retorna à Sala São Paulo.')}</p>
              <button>{t('Leia mais')}</button>
            </div>
          </div>
