...
function Exercicio3() {
  ...
  return (
    <div className="dash-exercicio3">
      ...
      />
      {showHelp && <div className="help-message">{t('Um acorde maior tem um som alegre, relaxado e consonante. Um acorde menor tem um som triste, descontraído e consonante. Pode ser útil cantar as notas de baixo para cima.')}</div>}
